...
#pragma warning restore 8618
        ...
        public override void Load()
        {
            ...
            BindSingleton<ITrackerWidgetLayout, HorizontalCategoryTableTrackerWidgetLayout>(TrackerWidgetLayout.HorizontalCategoryTable);
            BindSingleton<ITrackerWidgetLayout, VerticalCategoryTableTrackerWidgetLayout>(TrackerWidgetLayout .VerticalCategoryTable);
            BindSingleton<ITrackerWidgetLayout, HorizontalTrackerWidgetLayout>(TrackerWidgetLayout.Horizontal);
            BindSingleton<ITrackerWidgetLayout, VerticalTrackerWidgetLayout>(TrackerWidgetLayout.Vertical);
        }
